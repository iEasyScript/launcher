...
| Platform | Link |
|---|---|
| Windows (x86-64) | [project-x-launcher-windows-x86_64.zip](https://github.com/iEasyScript/launcher/releases/latest) |
| Linux (x86-64) | [project-x-launcher-linux-x86_64.tar.gz](https://github.com/iEasyScript/launcher/releases/latest) |
